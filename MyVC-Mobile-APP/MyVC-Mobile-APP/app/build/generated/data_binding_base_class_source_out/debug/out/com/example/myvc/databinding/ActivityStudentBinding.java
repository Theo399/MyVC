...
public final class ActivityStudentBinding implements ViewBinding {
  ...
  private ActivityStudentBinding(@NonNull DrawerLayout rootView, @NonNull DrawerLayout drawerLayout,
  ...
  public static ActivityStudentBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityStudentBinding((DrawerLayout) rootView, drawerLayout, frameLayout, navView,
          toolBar);
    }
